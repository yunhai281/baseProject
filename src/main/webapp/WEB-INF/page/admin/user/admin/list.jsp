	...
	<div class="container-fluid">
		<div class="row breadcrumb">
			<span class="byy-breadcrumb" separator=">">
				<a>用户管理</a> 
                <a><cite>系统管理员管理</cite></a>
            </span>
			<span class="byy-btn small pull-right resetPassword" style="margin-right:10px;"><i class="fa fa-key"></i>重置密码</span>
            ...
            <span class="byy-btn small pull-right list_add"><i class="fa fa-plus"></i>新增管理员</span>
		</div>
