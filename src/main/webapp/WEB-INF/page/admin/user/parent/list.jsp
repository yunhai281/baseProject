...
<body>
	<div class="container-fluid">
		<div class="row breadcrumb">
			...
			<span class="byy-btn small pull-right batchYes" style="margin-right:10px;" ><i class="fa fa-check"></i>批量启用</span>
			<span class="byy-btn small pull-right resetPassword"><i class="fa fa-key"></i>重置密码</span>
            <span class="byy-btn small pull-right list_add" ><i class="fa fa-plus"></i>新增家长</span>
		</div>
