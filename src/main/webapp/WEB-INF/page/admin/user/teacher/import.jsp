		...
		<form action="" class="byy-form">
		 	<div class="row tipdiv">
				...
				<span>
					...
					<span>1.教师学校、工号、姓名列为必填项，且工号不能重复；</span><br>
					<span>2.若没有工号，则可以按照序号来排列，尽量让学校领导的工号在前面；</span><br>
				</span>  
			</div>
			<div class="byy-form-item">
				...
				<div class="text-center" style="margin-top: 10px;">
					<h3><a href="<%=basePath %>/teacher_exportTeacherTemplateExcel.do" title="点击下载模版文件" target="_blank" style="color: #25c2b7;font-size: 20px;">模版</a></h3>
				</div>
			</div>
			<div class="byy-form-item">
				<div class="text-center">
