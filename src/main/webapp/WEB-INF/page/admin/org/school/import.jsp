		...
		<form action="" class="byy-form">
		 	<div class="row tipdiv">
				...
				<span>
					...
					<span>1.学校名称、学校代码、所属机构必填，且学校代码必须输入数字；</span><br>
					<span>2.学校名称、学校代码不可重复；</span><br>
				</span>  
			</div>
			<div class="byy-form-item">
				...
				<div class="text-center" style="margin-top: 10px;">
					<h3><a href="<%=basePath %>/school_exportSchoolTemplateExcel.do" title="点击下载模版文件" target="_blank" style="color: #25c2b7;font-size: 20px;">模版</a></h3>
				</div>
			</div>
			<div class="byy-form-item">
				<div class="text-center">
