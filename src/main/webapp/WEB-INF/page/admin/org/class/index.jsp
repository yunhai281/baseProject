...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-xs-9">
				<div id="right_content"  style="border-left: 1px solid #eee;">请点击左侧选择学校下的年级</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="<%=basePath%>resources/js/admin/org/class/list.js"></script>
</body>
</html>
