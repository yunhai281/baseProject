		...
		<form action="" class="byy-form">
		 	<div class="row tipdiv">
				...
				<span>
					...
					<span>1.机构名称、机构号码、机构等级，且机构号码只可位数字；</span><br>
					<span>2.机构名称、机构号码不可重复；</span><br>
				</span>  
			</div>
			<div class="byy-form-item">
				...
				<div class="text-center" style="margin-top: 10px;">
					<h3><a href="<%=basePath %>/government_exportSchoolTemplateExcel.do" title="点击下载模版文件" target="_blank" style="color: #25c2b7;font-size: 20px;">模版</a></h3>
				</div>
			</div>
			<div class="byy-form-item">
				<div class="text-center">
