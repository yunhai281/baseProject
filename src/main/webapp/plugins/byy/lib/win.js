...
doms.anim = ['byywin-anim', 'byywin-anim-01', 'byywin-anim-02', 'byywin-anim-03', 'byywin-anim-04', 'byywin-anim-05', 'byywin-anim-06'];
...
Class.pt.creat = function(){
  ...
  switch(config.type){
    ...
    case 2:
      ...
      config.content = '<iframe scrolling="'+ (config.content[1]||'auto') +'" allowtransparency="true" id="'+ doms[4] +''+ times +'" name="'+(config.frameName ||  (doms[4] +''+ times )) +'" onload="this.className=\'\';" class="byy-byywin-load" frameborder="0" src="' + config.content[0] + '"></iframe>';
    break;
    case 3:
      delete config.title;
  ...
  if(doms.anim[config.anim]){
    that.byywino.addClass(doms.anim[config.anim]).data('anim', true);
  };
};
...
byywin.getFrameIndexNew = function(window,name){
	var $body = $(window.parent.document);
	return $body.find('iframe').parents('.'+doms[4]).attr('times');
}
...
byywin.close = function(index){
  ...
  if(byywino.data('anim')){
    byywino.addClass(closeAnim);
  }
  ...
  setTimeout(function(){
    remove();
  }, ((byywin.ie && byywin.ie < 10) || !byywino.data('anim')) ? 0 : 200);
};
  ...
  return byywin.open($.extend({
    ...
    ,yes: function(index){
      ...
      if(value === ''){
        ...
        byywin.tips('&#x6700;&#x591A;&#x8F93;&#x5165;'+ (options.maxlength || 500) +'&#x4E2A;&#x5B57;&#x6570;', prompt, {tips: 1});
      } else {
  ...
  return byywin.open($.extend({
    ...
    success: function(byywino){
      ...
      btn.on('mousedown', function(e){
        ...
        othis.addClass('byy-byywin-tabnow').siblings().removeClass('byy-byywin-tabnow');
...
byywin.photos = function(options, loop, key){
  ...
  loadImage(data[start].src, function(img){
    ...
    byywin.close(dict.loadi);
    byywin.msg('&#x5F53;&#x524D;&#x56FE;&#x7247;&#x5730;&#x5740;&#x5F02;&#x5E38;<br>&#x662F;&#x5426;&#x7EE7;&#x7EED;&#x67E5;&#x770B;&#x4E0B;&#x4E00;&#x5F20;&#xFF1F;', {
      time: 30000, 
      btn: ['&#x4E0B;&#x4E00;&#x5F20;', '&#x4E0D;&#x770B;&#x4E86;'], 
      yes: function(){
...
window.byy && byy.define ? (
  byywin.ready()
  ,byy.define('jquery', function(exports){ //byy加载
